...
public static class Lake
{
    ...
    /// <summary>Download Mathlib's prebuilt .olean files instead of compiling Mathlib, which takes hours.</summary>
    ...
    /// (so it works with no elan default). The new project's <c>lean-toolchain</c> pins that toolchain.
    /// </summary>
    ...
    /// <summary>Is the name one Lake accepts as a package name?</summary>
