...
public static partial class Ffi
{
    ...
    /// <summary>The path has a C or C++ source or header extension (<c>.c</c>, <c>.h</c>, <c>.cpp</c>, <c>.cc</c>, <c>.hpp</c>, <c>.cxx</c>).</summary>
    ...
    {
        /// <summary>The type is passed unboxed, as a C scalar (<c>UInt32</c> as <c>uint32_t</c>, <c>Float</c> as <c>double</c>…).</summary>
        public bool IsScalar => Scalars.ContainsKey(Lean);
        /// <summary>
        /// The C type Lean uses for it: the scalar type, or for objects <c>lean_obj_res</c> as a result, <c>b_lean_obj_arg</c>
        /// when borrowed and <c>lean_obj_arg</c> when owned.
        /// </summary>
        /// <param name="result">True for the function's result, false for a parameter.</param>
