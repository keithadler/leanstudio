...
flowchart TB
    ...
    Core -->|child processes| Tools["lake · lean · elan · git · gh"]
...
| `Workflow/` | Project-wide tools: `Markers` (sorries and TODOs), build problems, tasks, local history, module rename, Compiled C (`EmittedC`), the elan installer and file operations. |
